...
Add-ListFieldIfMissing -ListTitle 'ItineraryEntries' -InternalName 'CabinTypeAndNumber' -FieldType 'Text'
Add-ListFieldIfMissing -ListTitle 'ItineraryEntries' -InternalName 'PackageName' -FieldType 'Text'
Add-ListFieldIfMissing -ListTitle 'ItineraryEntries' -InternalName 'PackageInclusions' -FieldType 'Note'
...
Add-ListFieldIfMissing -ListTitle 'TripReminders' -InternalName 'TripId' -FieldType 'Text'
Add-ListFieldIfMissing -ListTitle 'TripReminders' -InternalName 'DayId' -FieldType 'Text'
Add-ListFieldIfMissing -ListTitle 'TripReminders' -InternalName 'EntryId' -FieldType 'Text'
Add-ListFieldIfMissing -ListTitle 'TripReminders' -InternalName 'ReminderType' -FieldType 'Text'
Add-ListFieldIfMissing -ListTitle 'TripReminders' -InternalName 'ReminderText' -FieldType 'Note'
Add-ListFieldIfMissing -ListTitle 'TripReminders' -InternalName 'DueDate' -FieldType 'DateTime'
Add-ListFieldIfMissing -ListTitle 'TripReminders' -InternalName 'IsComplete' -FieldType 'Boolean'
Add-ListFieldIfMissing -ListTitle 'TripReminders' -InternalName 'TaskNote' -FieldType 'Text'
...
# --- TripMembers (per-trip roles: Editor / Companion / Follower) ---
Ensure-CustomList -Title 'TripMembers'
Add-ListFieldIfMissing -ListTitle 'TripMembers' -InternalName 'TripId' -FieldType 'Text'
